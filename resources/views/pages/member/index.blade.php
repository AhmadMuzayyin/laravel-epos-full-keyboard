...
@endphp
@section('contentHead')
    <a href="{{ route('dashboard') }}" role="button" class="btn btn-outline-{{ $theme == 'dark' ? 'light' : 'dark' }}"><i class="bi bi-box-arrow-left"></i> Esc -
        Kembali</a>
@endsection
@section('home')
    <div>
        <div class="row">
            <div class="col">
                <h3 class="mb-2 mt-2">Member</h5>
            </div>
            <div class="col text-end">
                <a href="#" role="button" class="btn btn-outline-{{ $theme == 'dark' ? 'light' : 'dark' }}" id="memberEdit"><i class="bi bi-pencil"></i>
                    Enter -
                    Simpan Perubahan</a>
                <a href="#" role="button" class="btn btn-outline-{{ $theme == 'dark' ? 'light' : 'dark' }}" id="memberDelete"><i
